...
#define FURI_HAL_PWM_DISPLAY_TIMER   TIM1
#define FURI_HAL_PWM_DISPLAY_CHANNEL LL_TIM_CHANNEL_CH1
...
static void furi_hal_pwm_display_timer_init(void) {
    ...
    LL_TIM_EnableAllOutputs(FURI_HAL_PWM_DISPLAY_TIMER);
}
...
void furi_hal_pwm_set_params(FuriHalPwmOutputId channel, uint32_t freq, uint8_t duty) {
    ...
    LL_TIM_OC_SetCompareCH1(FURI_HAL_PWM_DISPLAY_TIMER, compare);

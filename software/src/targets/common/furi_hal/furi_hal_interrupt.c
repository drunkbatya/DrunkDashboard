...
const IRQn_Type furi_hal_interrupt_irqn[FuriHalInterruptIdMax] = {
    // TIM1, TIM16, TIM17
    [FuriHalInterruptIdTim1TrgComTim17] = TIM1_TRG_COM_IRQn,
    [FuriHalInterruptIdTim1Cc] = TIM1_CC_IRQn,
    [FuriHalInterruptIdTim1UpTim16] = TIM1_UP_IRQn,
    ...
    // TIM8
    [FuriHalInterruptIdTim8Cc] = TIM8_CC_IRQn,

    // DMA1
    [FuriHalInterruptIdDma1Ch1] = GPDMA1_Channel1_IRQn,
    [FuriHalInterruptIdDma1Ch2] = GPDMA1_Channel2_IRQn,
    [FuriHalInterruptIdDma1Ch3] = GPDMA1_Channel3_IRQn,
    [FuriHalInterruptIdDma1Ch4] = GPDMA1_Channel4_IRQn,
    [FuriHalInterruptIdDma1Ch5] = GPDMA1_Channel5_IRQn,
    [FuriHalInterruptIdDma1Ch6] = GPDMA1_Channel6_IRQn,
    [FuriHalInterruptIdDma1Ch7] = GPDMA1_Channel7_IRQn,

    // DMA2
    [FuriHalInterruptIdDma2Ch1] = LPDMA1_Channel1_IRQn,
    [FuriHalInterruptIdDma2Ch2] = LPDMA1_Channel2_IRQn,
    [FuriHalInterruptIdDma2Ch3] = LPDMA1_Channel3_IRQn,
    [FuriHalInterruptIdDma2Ch4] = GPDMA1_Channel8_IRQn,
    [FuriHalInterruptIdDma2Ch5] = GPDMA1_Channel9_IRQn,
    [FuriHalInterruptIdDma2Ch6] = GPDMA1_Channel10_IRQn,
    [FuriHalInterruptIdDma2Ch7] = GPDMA1_Channel11_IRQn,
    ...
    // RTC
    [FuriHalInterruptIdRtcAlarm] = RTC_IRQn,

    // HSEM is not present on STM32U585; keep the slot invalid.
    [FuriHalInterruptIdHsem] = NonMaskableInt_IRQn,
    ...
    // FDCAN
    [FuriHalInterruptIdFdcan1It0] = FDCAN1_IT0_IRQn,
    [FuriHalInterruptIdFdcan1It1] = FDCAN1_IT1_IRQn,
};
...
void furi_hal_interrupt_init(void) {
    NVIC_SetPriority(LSECSSD_IRQn, NVIC_EncodePriority(NVIC_GetPriorityGrouping(), 0, 0));
...
void TIM8_CC_IRQHandler(void) {
    furi_hal_interrupt_call(FuriHalInterruptIdTim8Cc);
}
...
void LPDMA1_Channel2_IRQHandler(void) {
...
void FDCAN1_IT0_IRQHandler(void) {
    furi_hal_interrupt_call(FuriHalInterruptIdFdcan1It0);
}
void FDCAN1_IT1_IRQHandler(void) {
    furi_hal_interrupt_call(FuriHalInterruptIdFdcan1It1);
}

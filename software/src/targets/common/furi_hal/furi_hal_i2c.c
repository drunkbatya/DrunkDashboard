...
void furi_hal_i2c_init_early(void) {
    furi_hal_i2c_bus_i2c1.callback(&furi_hal_i2c_bus_i2c1, FuriHalI2cBusEventInit);
}

void furi_hal_i2c_deinit_early(void) {
    furi_hal_i2c_bus_i2c1.callback(&furi_hal_i2c_bus_i2c1, FuriHalI2cBusEventDeinit);
}
